...
function ProductList({ onHomeClick }) {
    ...
    const cartCount = cart.reduce((total, item) => total + item.quantity, 0); // total quantity of all products
  ...
  <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
    <div style={{ position: 'relative' }}> {/* Needed for badge positioning */}
      <h1 className='cart'>
      ...
      {cart.length > 0 && (  // Show badge only if cart has items
        <span style={{
          position: 'absolute',
          top: '-5px',
          right: '-5px',
          ...
          {cart.reduce((total, item) => total + item.quantity, 0)} {/* Total quantity of items */}
        </span>
      )}
    </div>
  </a>
